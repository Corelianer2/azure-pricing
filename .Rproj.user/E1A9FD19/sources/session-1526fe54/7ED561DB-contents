...
# Goal: Analyze the Microsoft Windows Azure prices for a specific virtual machine type (D32ads v6) and visualize the data on a world map, highlighting the Proceq offices.
# Load the pricing data from the Microsoft Azure API into a DuckDB database and perform the following steps:
